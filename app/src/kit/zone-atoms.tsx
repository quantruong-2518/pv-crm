...
import { Kicker, Separator } from '@/components/ui/separator'
...
export function ZoneAtoms() {
  return (
    <section id="zone-01" className="pt-12 pb-2">
      ...
      <ZoneBody className="grid grid-cols-3 gap-4">
        ...
        <SpecCard
          ...
          footer={
            <>
              ...
              <br />
              ghost → bg-white/10 · destructive → bg-destructive/20 text-destructive-foreground · nút
              tablet luôn size lg (≥48px)
            </>
          }
        >
        ...
        >
          ...
          <div className="ml-1 text-[11.5px] leading-[1.6] text-muted-foreground">
            38 · 30 · 24
            <br />
        ...
        >
          {STATUS_DOTS.map((dot) => (
            <div key={dot.state} className="flex items-center gap-2.5">
              ...
              <span className="text-[12px] text-muted-foreground">{dot.text}</span>
            </div>
          ))}
        </SpecCard>
        ...
        >
          <div className="flex items-baseline justify-between">
            <span className="text-[12px] text-muted-foreground">KPI hero</span>
            <Money value={1_840_000_000} scale="hero" />
          </div>
          <div className="flex items-baseline justify-between">
            <span className="text-[12px] text-muted-foreground">Trong thẻ</span>
            <Money value={128_500_000} />
          </div>
          <div className="flex items-baseline justify-between">
            <span className="text-[12px] text-muted-foreground">Trong bảng</span>
