...
export const SEMANTIC_TOKENS: Array<{ token: string; css: string; note: string }> = [
  ...
  { token: '--accent-foreground', css: 'var(--accent-foreground)', note: '#7FA3FF · MỌI chữ màu azure' },
  { token: '--muted-foreground', css: 'var(--muted-foreground)', note: '#93A1B8 · chú thích, nhãn' },
