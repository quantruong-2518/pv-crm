...
import { OrderLifecycleCard } from '@/components/organisms/order-lifecycle-card'
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5 lg:gap-6">
        ...
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-4 lg:auto-rows-[150px] lg:gap-4">
          <OrderLifecycleCard
          ...
          <StatCard
            ...
            sparkline={{ points: [22, 18, 20, 13, 15, 8, 9, 3], source: 'Aug · Sales', tone: 'success' }}
          />
          <StatCard
            value="86%"
            label="On-time delivery"
            delta={{ direction: 'flat', text: 'flat · target 90%', tone: 'warning' }}
            sparkline={{ points: [12, 11, 13, 12, 12, 13, 11, 12], source: '90d · Supply', tone: 'warning' }}
          />
          <StatCard
            value="₫890M"
            label="Overdue receivables"
            delta={{ direction: 'up', text: '2 invoices · 12 days overdue', tone: 'danger' }}
            sparkline={{ points: [20, 19, 16, 17, 11, 10, 6, 4], source: '30d · Finance', tone: 'danger' }}
          />
          <StatCard
            value="91.4%"
            label="Equipment effectiveness · plant X1"
            delta={{ direction: 'down', text: 'CNC-03 down 37 min', tone: 'warning' }}
            sparkline={{ points: [6, 5, 8, 7, 6, 14, 19, 11], source: '24h · Factory', tone: 'warning' }}
          />
