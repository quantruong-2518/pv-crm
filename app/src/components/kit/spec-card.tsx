  ...
  return (
    <section className={cn('glass-b-flat overflow-hidden rounded-lg', className)}>
      <header className="flex items-center gap-2.5 bg-white/[4.5%] px-4 py-[11px]">
        <span className="font-mono text-[10px] tracking-[.1em] text-muted-foreground">{code}</span>
      ...
      {footer && (
        <footer className="bg-black/20 px-4 py-2.5 font-mono text-[10px] leading-[1.8] text-muted-foreground">
          {footer}
        </footer>
      )}
    </section>
