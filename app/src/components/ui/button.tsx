...
const buttonVariants = cva(
  'motion-std inline-flex items-center justify-center gap-2 rounded-md font-semibold whitespace-nowrap disabled:pointer-events-none',
  {
    variants: {
      variant: {
  ...
  ({ className, variant, size, disabled, ...props }, ref) => (
    <button
      ...
      className={cn(
        ...
        disabled && 'cursor-not-allowed bg-white/5 text-muted-foreground shadow-none',
        className,
      )}
      {...props}
    />
