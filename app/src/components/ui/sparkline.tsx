...
export function Sparkline({ points, tone = 'primary', source, height = 26, className }: SparklineProps) {
  ...
  return (
    <div className={cn('flex items-end gap-3', className)}>
      ...
      <span className="font-mono text-[9.5px] text-muted-foreground">{source}</span>
    </div>
  )
}
