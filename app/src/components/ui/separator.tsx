...
export function Separator({
  ...
  return (
    <div
      ...
      className={cn(
        'h-px',
        fade ? 'bg-[linear-gradient(90deg,rgb(255_255_255/.18),rgb(255_255_255/.02))]' : 'bg-white/8',
        className,
      )}
    />
  )
  ...
  return (
    <div
      className={cn(
        ...
        tone === 'accent'
          ? 'font-semibold tracking-[.2em] text-accent-foreground'
          : 'tracking-[.13em] text-muted-foreground',
        className,
      )}
    >
      {children}
