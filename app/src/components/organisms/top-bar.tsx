...
import { SearchField, type SearchFieldProps } from '@/components/patterns/search-field'
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="motion-std hidden h-10 items-center gap-2 rounded-md bg-[linear-gradient(135deg,color-mix(in_srgb,var(--primary)_30%,transparent),color-mix(in_srgb,var(--primary)_12%,transparent))] px-4 text-[12.5px] font-semibold text-accent-foreground shadow-[var(--shadow-assistant),inset_0_1px_0_var(--sheen-ai)] hover:brightness-[1.12] lg:flex"
      >
