/** Tiền chuẩn VN: phẩy thập phân, chấm ngăn nghìn (luật 6 · docs/design-system/laws.md).
...
export function billions(amount: number, fractionDigits = 2) {
  return `${vi(amount / 1_000_000_000, fractionDigits)} tỷ`
}

/** 128_500_000 → "128,5 tr" · dùng trong thẻ. */
export function millions(amount: number, fractionDigits = 1) {
  return `${vi(amount / 1_000_000, fractionDigits)} tr`
}
