...
export function ScanField({ code, state = 'idle', message, onScan, className }: ScanFieldProps) {
  return (
    <div className={className}>
      <div className="flex items-center gap-2.5">
        ...
        <button
          ...
          className="motion-std bg-primary text-primary-foreground shadow-primary flex size-14 shrink-0 items-center justify-center rounded-md hover:brightness-[1.12]"
        >
