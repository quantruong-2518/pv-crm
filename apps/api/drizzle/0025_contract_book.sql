...
ALTER TABLE "sales"."contract_payment_term" ADD CONSTRAINT "contract_payment_term_contract_code_contract_code_fk" FOREIGN KEY ("contract_code") REFERENCES "sales"."contract"("code") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
