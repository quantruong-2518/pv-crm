...
export const SCREENS: ScreenDef[] = [
  ...
  {
    /** The contract book — module 4, and it is INSERTED into the sequence
     *  rather than appended to the end.
     *
     *  The numbers follow the sales journey (1 campaigns, 2 leads, 3 deals), so
     *  quotes and contracts belong at 4 and everything after it shifts by one:
     *  Performance to 5, Plan to 6, Config to 7. Section 1 of
    ...
    name: 'Kinh doanh · Module 4 · Sổ hợp đồng',
    branch: 'Sales',
